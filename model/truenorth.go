...
// reading one would return the default and mask a real north. When a file
// carries several top-level contexts the lowest express ID wins, so the answer
...
func TrueNorth(f *step.File) [2]float64 {
	...
	// azimuth downstream without erroring.
