...
- [The pipeline](concepts/pipeline.md) — what each of the three stages does, and
  how to use one on its own.
- [Sections and floor plans](guides/sections.md) — cutting the model with a plane.
- [Limitations](limitations.md) — the edges, stated plainly.
